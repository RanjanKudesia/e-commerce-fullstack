...
// // Handling GET request to fetch all categories with category_level === 1, limited to 20 documents
// app.get("/product-category", async (c) => {
//   const colRef = collection(db, "categories");

//   try {
//     // Create a query to filter documents where category_level === 1 and limit the result to 20 documents
//     const q = query(colRef, where("category_level", "==", 1), limit(20));
