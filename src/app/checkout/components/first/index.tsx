...
export default function First() {
  return (
    <div className="flex flex-row justify-between items-center md:px-[120px] md:pt-[60px] md:pb-[52px] relative  ">
      <div className="absolute left-0 -z-10 min-w-full h-[333px] bg-[#F7F7F7]"></div>
