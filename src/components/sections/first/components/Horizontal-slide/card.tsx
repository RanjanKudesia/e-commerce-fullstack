...
export default function Card({
  ...
  return (
    <div className="flex flex-col md:flex-row pt-[102px] md:pt-[188px] px-[24px] md:pl-[120px] min-h-[620px] bg-[#F7F7F7] md:pb-[192px] gap-[32px] relative">
      ...
      >
        <Image
          // right-54 and top + 43
          className="absolute right-[50%] bottom-[25%] md:right-[457px] md:top-[213px] "
